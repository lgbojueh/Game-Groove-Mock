export default function About() {
  return (
    <main className="p-6 bg-[var(--background)] text-[var(--foreground)] min-h-screen">
      <h1 className="text-5xl font-bold mb-6">About Game Grove</h1>
      <section className="mb-4">
        ...
        <p className="mb-2">
          <strong>Our Purpose:</strong> Game Grove helps users find the best board game based on their preferences. Our recommendations consider several key factors, such as:
        </p>
